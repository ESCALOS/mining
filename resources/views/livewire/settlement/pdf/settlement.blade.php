...
<html lang="es">
<head>
	<title>Liquidación PDF - Innova Mining Company</title>
	...
	<div class="container">
		<div class="mt-4 row">
            <table style="width: 100%" class="text-center">
                <tr>
                    <td width="33.4%">
                        <div class="mb-3 col-md-6 text-md-center mb-md-0">
                            <img src="https://i.ibb.co/87CDdQC/logo-innova-mining-company.jpg" alt="Innova Mining Company" style="max-width: 200px;">
                        </div>
                    </td>
                    <td>
                        <div class="p-0 mb-0 col-md-6 text-md-left">
                            <p class="mb-0">Los Pinos, Mza. K Lote 10 - San Juan de Lurigancho</p>
                            <p class="mb-0">Teléfono: 943 358 092</p>
                            <p class="mb-0">info@innovaminingcompany.com | innova_min_com@hotmail.com</p>
                        </div>
                    </td>
                </tr>
            </table>
		...
		<div class="container">
            ...
            <table class="table table-bordered" style="width: 100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Ag Oz/TC</td>
                        <td>{{ floatval($settlement->Law->silver*$settlement->Law->silver_factor) }}</td>
                    ...
                    <tr>
                        <td>Au Oz/TC</td>
                        <td>{{ floatval($settlement->Law->gold*$settlement->Law->gold_factor) }}</td>
